// rdf-reasoner-konclude releases a loaded knowledge base only through terminate(), and every
// reasoning call builds a new one in WASM linear memory. Measured with rdf-reasoner-konclude
// 0.7.1 on PMDco + the Fe-Si record over 8 calls: one reused reasoner grew by 1,740 MB, a
// fresh reasoner per call by 15 MB. Each full reasoning run therefore starts a fresh reasoner.
